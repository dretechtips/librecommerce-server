...
Rating.prototype.test = isAvailable({
...
function buildRequestData(data) {
  ...
  response +=
    "	      <ShipperNumber>" + shipment.shipperNumber + "</ShipperNumber>";

  if (!data.shipment.shipper.address)
    return { success: false, error: "Missing shipment address" };
  var shipperAddress = data.shipment.shipper.address;

  response += "	      <Address>";
  response +=
    "	        <AddressLine1>" + shipperAddress.addressLine + "</AddressLine1>";
  ...
  response +=
    ...
    "</StateProvinceCode>";
  response +=
    "	        <PostalCode>" + shipperAddress.PostalCode + "</PostalCode>";
  response +=
    "	        <CountryCode>" + shipperAddress.countryCode + "</CountryCode>";
  response += "	      </Address>";
  response += "	    </Shipper>";
  ...
  response +=
    ...
    "</StateProvinceCode>";
  response +=
    "	        <PostalCode>" + shipFrom.address.postalCode + "</PostalCode>";
  response +=
    "	        <CountryCode>" + shipFrom.address.countryCode + "</CountryCode>";
  response += "	      </Address>";
  response += "	    </ShipFrom>";

  if (!data.shipment.service)
    return { success: false, error: "Missing shipment service" };
  ...
  if (!data.shipment.schedule)
    return { success: false, error: "Missing Shipment Schedule" };
