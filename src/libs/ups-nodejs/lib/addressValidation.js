...
AddressValidation.prototype.test = isAvailable({
...
function buildRequestData(data) {
  ...
  if (!data.stateProvinceCode)
    return { success: false, error: "Missing State Province Code" };
  response +=
    "<StateProvinceCode>" + data.stateProvinceCode + "</StateProvinceCode>";
